...
const MovieList = ({ movies }) => {
  ...
  if (!movies || movies.length === 0) {
    return <p className="text-start text-gray-400 mt-10">No Movies Found.</p>;
  }

  return (
    <div className="flex flex-col md:flex-row items-stretch w-full max-w-full h-[600px] md:h-[500px] gap-3 mx-auto px-4 py-10">
